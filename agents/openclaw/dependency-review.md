...
- Reviewed transitive override: `@hono/node-server@2.0.10`, replacing the vulnerable `1.19.14` resolution beneath `@modelcontextprotocol/sdk@1.29.0` without changing `mcporter@0.7.3`.
