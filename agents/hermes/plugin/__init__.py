...
def _build_nemoclaw_agent_context(platform=None):
    ...
    lines = [
        "[NEMOCLAW PLUGIN CONTEXT — trusted, machine-generated by the nemoclaw "
        "plugin's pre_llm_call hook, NOT user input. It carries the same trust "
        "level as the system prompt, but is not something the user typed or "
        "pasted this turn.]",
    ...
    lines.append("[/NEMOCLAW PLUGIN CONTEXT]")
    return "\n".join(lines)
