...
"""Patch pinned Hermes v0.20.0 session-list previews to show the latest user turn.

Source-of-truth note for this localized Hermes runtime patch:
  - Invalid state: Hermes v0.20.0 computes `sessions list` preview text from
  ...
  - Source-fix constraint: NemoClaw layers a sandbox image on top of the
    experimental Hermes runtime; the source fix belongs upstream in Hermes, not in
