...
export default class SandboxSessionsListCommand extends NemoClawCommand {
  ...
  static description =
    "Pass through to `openclaw sessions list` in the sandbox, hiding legacy internal NemoClaw warm-up sessions from default user-facing output. All OpenClaw flags (--agent, --all-agents, --active, --limit, --json, --store, --verbose) are forwarded verbatim.";
