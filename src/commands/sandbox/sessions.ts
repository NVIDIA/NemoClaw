...
export default class SandboxSessionsCommand extends NemoClawCommand {
  ...
  static description =
    "Pass through to `openclaw sessions` in the sandbox. With no subcommand the in-sandbox CLI lists stored sessions for the configured default agent, hiding legacy internal NemoClaw warm-up sessions from default user-facing output. Additional OpenClaw flags are forwarded verbatim after the sandbox name.";
