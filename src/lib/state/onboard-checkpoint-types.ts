...
/** Secret-free gateway lifecycle identity bound to one onboarding attempt. */
export interface CheckpointGatewayOwner {
...
export interface OnboardCheckpoint {
  ...
  /** Null only for sessions created before gateway-owner checkpointing. */
  readonly gatewayOwner: CheckpointGatewayOwner | null;
