...
export const COMMANDS: readonly CommandDef[] = [
  ...
  {
    usage: "nemoclaw <name> export",
    description: "Export sandbox to backup file",
    flags: "[path]",
    group: "Sandbox Management",
    scope: "sandbox",
  },
  ...
  {
    usage: "nemoclaw backups",
    description: "List all available sandbox backups",
    group: "Backup",
    scope: "global",
  },
  {
    usage: "nemoclaw import",
    description: "Import a sandbox from a backup file",
    flags: "<path> [new-name]",
    group: "Backup",
    scope: "global",
  },
