...
describe("agent definitions", () => {
  ...
  it("parses a declarative key-allowlist restore ownership block", () => {
  ...
  it("parses the openclaw-config named restore strategy", () => {
  ...
  it("rejects an unknown state-file restore merge strategy", () => {
  ...
  it("rejects a key-allowlist restore without user_keys", () => {
  ...
  it("rejects a restore block on a sqlite_backup state file", () => {
  ...
  it("rejects enum user_keys without values", () => {
  ...
  it("rejects values on a non-enum user_key", () => {
  ...
  it("rejects user_keys bounds on non-numeric types", () => {
  ...
  it("rejects openclaw-config restore with extra ownership fields", () => {
