...
const GATEWAY_NAME = gatewayState.getGatewayName(GATEWAY_PORT);
...
async function createSandbox(
  ...
  const sandboxRuntimeFields = getSandboxRuntimeRegistryFields(effectiveSandboxGpuConfig, GATEWAY_NAME);
