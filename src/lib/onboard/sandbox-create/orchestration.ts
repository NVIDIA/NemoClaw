...
import { assertRecordedPolicyAuthority } from "../../policy/policy-authority";
              ...
              ...(apfInterceptorRequested
                ? {
                    ...
                    persistRetainedApfSandboxRecovery: (
                      ...
                      const persisted = onboardSession.finalizeIncompleteOnboardStep(
                        "sandbox",
                        recovery.message,
                      );
                      return (
                        persisted?.failure?.message === recovery.message &&
                        persisted.steps.sandbox?.error === recovery.message
                      );
                    },
                  }
                : {}),
