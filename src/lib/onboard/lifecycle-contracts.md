...
| Runtime metadata | `routerPid`, `routerPort`, `routerCredentialHash`, `gpuPassthrough` | Router and sandbox setup/recovery. PID is a live-process hint; port is the durable cleanup target; credential hash is a digest; GPU is a concrete boolean. |
