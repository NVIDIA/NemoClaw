...
import {
  createFakeSharedStateDocker,
  type FakeSharedStateDockerOptions,
} from "./__test-helpers__/docker-shared-state-fixture";
...
function fakeSharedStateDocker(
  ...
  return createFakeSharedStateDocker(CONTAINER_ID, initialStatus, options);
}
