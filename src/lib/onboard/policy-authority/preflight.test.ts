...
describe("sandbox policy authority preflight", () => {
  ...
  it("accepts a stable route reservation over a durably verified sandbox (#10153)", () => {
    const recorded = {
      ...managedSandboxEntry("demo"),
      ...
      qualifySandboxPolicyAuthority(
        {
          ...
          prepareRequiredPolicy: () => requiredPolicy,
          operation: "rotate a messaging credential in sandbox 'demo'",
        },
        {
          inspectSandboxPolicyAuthority: managedPolicyInspection,
          inspectOpenShellSandboxIdentityFingerprint: () => SANDBOX_IDENTITY,
  ...
  it("refuses a pending route without durable reservation ownership (#10153)", () => {
    const recorded = {
      ...managedSandboxEntry("demo"),
      pendingRouteReservation: true as const,
