...
/**
 * Canonical active-channel selection shared by the image applier and the
 * managed-startup transaction planner. Durable rollback receipts must cover
 * exactly the outputs that the applier can mutate.
 */
