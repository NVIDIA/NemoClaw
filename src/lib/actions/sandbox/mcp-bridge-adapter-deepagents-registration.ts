...
export function buildDeepAgentsMcpRegisterCommand(
  ...
  return [
    ...
    "    close_managed_projection_descriptors(source_descriptor, source_parent_descriptor)",
    "    print(message, file=sys.stderr)",
    "    raise SystemExit(2)",
    "try:",
    "    data, source_identity, source_descriptor, source_parent_descriptor, source_parent_identity = load_managed_projection_for_update(config_path)",
    ...
    "try:",
    "    write_managed_projection(config_path, data, source_identity, source_descriptor, source_parent_descriptor, source_parent_identity)",
