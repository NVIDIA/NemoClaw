...
describe("Hermes Portable probe-only forward recovery", () => {
  ...
  it("accepts OpenShell's canonical empty forward-list response as an empty set", () => {
  ...
  it("accepts OpenShell's canonical empty response when the CLI writes it to stderr", () => {
  ...
  it("accepts a reachable direct service forward that is absent from the legacy list", () => {
    const fixture = createRecoveryFixture();
