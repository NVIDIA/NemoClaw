  ...
  try {
    ...
    switch (subcommand) {
      ...
      case "list": {
        ...
        if (json)
          // lgtm[js/clear-text-logging] The JSON summary contains validated MCP metadata and environment names, never values.
      ...
      case "status": {
        ...
        if (json) {
          // lgtm[js/clear-text-logging] Status serialization is schema-bounded and excludes credential values.
          console.log(
            JSON.stringify(
