...
async function removeSandboxChannelUnlocked(
  ...
  // Bailing here is the only way to keep #3998 from recurring on cleanup error.
  // A missing registry, unavailable provider cleanup, or absent stopped runtime remains
  // a quiet no-op only when no logical residue exists (#4001 review).
  if (
