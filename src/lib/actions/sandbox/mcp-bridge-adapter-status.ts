...
export function buildDeepAgentsMcpStatusCommand(
  ...
  return [
    ...
    "try:",
    `    data = read_managed_projection(config_path, ${JSON.stringify(DEEPAGENTS_UNSAFE_MCP_PROJECTION_PREFIX)})[0] if is_v2 else read_legacy_config(config_path)[0]`,
    "except FileNotFoundError:",
    "    data = {}",
    "except ValueError as exc:",
    `    if str(exc).startswith('${DEEPAGENTS_UNSAFE_MCP_PROJECTION_PREFIX}: '):`,
