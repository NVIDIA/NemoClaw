...
async function printAgentVersion(context: SandboxStatusTextContext, sandbox: SandboxEntry): Promise<void> {
  try {
...
export async function printSandboxDetails(context: SandboxStatusTextContext): Promise<SandboxStatusTextOutcome> {
