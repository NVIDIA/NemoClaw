...
/**
 * Exercise the configured gateway route from the still-running sandbox. This
 * uses OpenShell's stored provider credential through inference.local, never an
 * ambient host credential, and therefore catches rejected keys before delete.
 */
