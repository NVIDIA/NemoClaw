...
export const DEEPAGENTS_MANAGED_PROJECTION_READ_HELPERS = [
  ...
  "    return None",
  "def reject_unsafe_managed_projection(metadata, unsafe_path_prefix):",
  "    unsafe_path_kind = managed_projection_path_kind(metadata.st_mode) if unsafe_path_prefix else None",
  "    if unsafe_path_kind:",
  ...
  "def assert_managed_source_stable(path, identity, unsafe_path_prefix=None):",
  "    try:",
  ...
  "            reject_unsafe_managed_projection(current_metadata, unsafe_path_prefix)",
  ...
  "def validate_managed_descriptor_path(path, descriptor, unsafe_path_prefix=None):",
  "    opened = os.fstat(descriptor)",
  "    linked = os.stat(path, follow_symlinks=False)",
  "    reject_unsafe_managed_projection(linked, unsafe_path_prefix)",
  ...
  "    except FileNotFoundError:",
  "        assert_managed_source_stable(path, None, unsafe_path_prefix)",
  "        return b'', None, None",
  ...
  "        reject_unsafe_managed_projection(before, unsafe_path_prefix)",
  "        validate_managed_descriptor_path(path, descriptor, unsafe_path_prefix)",
  ...
  "        reject_unsafe_managed_projection(linked_after, unsafe_path_prefix)",
  ...
  "    raw, identity, descriptor = open_managed_projection(path, unsafe_path_prefix=unsafe_path_prefix)",
  "    try:",
