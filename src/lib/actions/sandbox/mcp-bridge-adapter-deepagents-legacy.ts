...
import {
  ...
  DEEPAGENTS_RUNTIME_SELECTION_HELPERS,
...
export function buildDeepAgentsMcpRollbackRegisterCommand(
  ...
  return [
    ...
    ...DEEPAGENTS_RUNTIME_SELECTION_HELPERS,
    ...MANAGED_HTTP_SERVER_MATCH_HELPERS,
    "runtime_kind = select_deepagents_runtime_kind('auto', managed_path, legacy_path)",
    ...
    "try:",
    "    if is_v2:",
    "        data, managed_identity, managed_descriptor, managed_parent_descriptor, managed_parent_identity = load_managed_projection_for_update(config_path)",
    "    else:",
    "        data, legacy_identity, legacy_descriptor, legacy_parent_descriptor, legacy_parent_identity = load_legacy_config_for_update(config_path, True)",
