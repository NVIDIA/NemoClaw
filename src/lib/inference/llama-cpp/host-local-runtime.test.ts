...
describe("llama.cpp host-local runtime materializer", () => {
  it("binds an existing verified model blob into the declarative Spark runtime (#8144)", () => {
  ...
  it("rejects unsafe runtime bindings and weakened declarative policy (#8144)", () => {
    expect(() =>
      buildLlamaCppHostLocalDockerArgv(contract(), {
        ...bindings(),
