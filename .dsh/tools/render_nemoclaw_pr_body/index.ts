...
out.push(
  ...
  check(
    ...
    input.ciWaiver
      ? input.ciWaiver.check + "; " + input.ciWaiver.approval + "; #" + input.ciWaiver.followUpIssue
      : undefined,
  ),
  "",
  ...
  check("Doc pages follow the style guide (doc changes only)", input.docs?.styleReviewed === true),
  check(
