...
# anchors, and the PERL_* arguments pin public source and package identities.
# NEMOCLAW_DCODE_VALIDATION_PROFILE_B64 supplies non-secret validation data.
