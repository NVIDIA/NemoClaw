...
function parseIdentityFrame(bytes, expectedServiceBundle, expectedTargetImage) {
...
function socketIdentity(socketPath, expectedGid) {
...
async function probe(socketPath, expectedGid, expectedServiceBundle, expectedTargetImage) {
