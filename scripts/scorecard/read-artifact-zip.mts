...
/**
 * Reads one exact root-level file from a GitHub artifact ZIP without extracting
 * paths to disk. The archive may contain other entries, but duplicate target
 * entries, links, encryption, split archives, ZIP64, and oversized payloads are
 * rejected.
 */
