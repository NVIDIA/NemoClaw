...
START_LOG_DIAGNOSTIC_PATTERNS = (
    ...
    re.compile(
        r"\[gateway\] Hermes pre-launch layout repair failed at (?:sessions state directory|gateway state directory|runtime state directory|logs directory|history file)"
    ),
    re.compile(
