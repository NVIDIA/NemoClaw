...
# Image-owned bootstrap boundary. Docker creates this replacement without
# starting it, copies one bounded root-owned request into its writable layer,
# and then starts this trampoline as PID 1. The OpenShell supervisor and agent
