...
usage() {
  ...
  printf "                                  | gemini | ollama | ollama-remote | custom | nim-local | vllm | routed\n"
  printf "                                  (aliases: anthropiccompatible -> anthropicCompatible, cloud -> build, nim -> nim-local, ollamaremote -> ollama-remote, remote-ollama -> ollama-remote)\n"
