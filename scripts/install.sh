...
describe_express_install() {
  ...
  case "$platform" in
    ...
    "DGX Station")
      ...
      printf "  DGX Station is Tested with limitations on one DGX Station GB300 running DGX OS 7.5; dual-Station configurations are not yet validated, and dedicated CI coverage is not available.\n"
      sandbox_summary="${NEMOCLAW_SANDBOX_NAME:-my-assistant}"
      ;;
    "Windows WSL")
