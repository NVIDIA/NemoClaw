...
const TRUSTED_OPENSHELL_RELEASES: readonly OpenShellReleaseTrust[] = [
  ...
  {
    // The third template is pre-authorized because dependent installer validation reads this
    // trust record from the base branch.
    brevTemplateSha256: [
      ...
      "5674b528f6604b30b31fbf3877e4f5d53abc08e88c0a352070a898cfd7eaa7bf",
    ],
    formula: {
      asset: "openshell.rb",
