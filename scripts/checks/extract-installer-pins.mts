...
const TRUSTED_OPENSHELL_RELEASES: readonly OpenShellReleaseTrust[] = [
  ...
  },
  {
    ...
    // Reviewed normalized templates for the 0.0.106 installer. The second
    // permits the early strings dependency check from #9705. These trust
    // prerequisites leave the selected product release unchanged.
    installerTemplateSha256: [
