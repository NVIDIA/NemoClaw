...
export function NationalityDropdown() {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200 hover:border-slate-400
          text-sm font-medium text-slate-700 transition-all shadow-sm whitespace-nowrap"
      >
      ...
      {open && (
        <div className="absolute top-full right-0 mt-1.5 w-48 bg-white rounded-xl shadow-xl border border-slate-100 z-50 overflow-hidden">
          <div className="py-1">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    {language === 'ko' && (
                      <span className="text-xs text-slate-400">{meta.labelEn}</span>
                    )}
                  </div>
                  {isSelected && (
