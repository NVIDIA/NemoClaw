...
Account-specific limits in `.github/pr-limits.yaml` override the default.
...
> [!WARNING]
> Accounts that repeatedly exceed their numeric limit or submit automated bulk PRs may have their PRs closed or their access restricted.
