...
# Non-secret flag: name of the web search provider when web search is enabled.
# Defaults to "brave"; "duckduckgo" is gated behind NEMOCLAW_EXPERIMENTAL=1
# during onboard and is keyless (no API key is baked or injected).
