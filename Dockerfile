...
RUN set -eu; \
    ...
    if [ "$USE_REVIEWED_BASE_RUNTIME" = "1" ]; then \
        ...
        case "$OPENCLAW_VERSION" in \
            2026.4.24|2026.6.10|2026.7.1) node /usr/local/lib/node_modules/openclaw/scripts/postinstall-bundled-plugins.mjs ;; \
            2026.3.11) ;; \
...
RUN set -eu; \
    ...
    install_reviewed_openclaw_plugin() { \
        ...
        case "$plugin_spec" in \
            "@openclaw/diagnostics-otel@2026.6.10"|"@openclaw/diagnostics-otel@2026.7.1") \
