...
class NativeTelemetry(unittest.IsolatedAsyncioTestCase):
    async def test_native_gateway_exports_a_trace_to_the_owned_collector(self):
        ...
        options = {
            "api": "openai-completions",
            "tuning": {},
            "execution": {"timeoutSeconds": 1, "heartbeatEvery": "0m"},
            "observability": {
                "otlp": {
                    "enabled": True,
                    "endpoint": "http://host.openshell.internal:4318",
                    "serviceName": "nemoclaw-trace-fixture",
                    "sampleRate": 1,
                }
            },
        }
                ...
                try:
                    ...
                    try:
                        await runtime.rpc(
                            ...
                            {
                                "agentId": "main",
                                "sessionKey": "agent:main:trace-fixture",
                                "message": "fixture",
                                "idempotencyKey": "trace-once",
                                "deliver": False,
                                "timeout": 1,
                            },
                            timeout=10,
