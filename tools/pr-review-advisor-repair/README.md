...
- `selection.json`, `selection-authority.json`, `artifact-manifest.json`, and `repair-context.json`, bound to the live PR, exact Advisor artifact digests, canonical finding ledgers, and review-thread state;
