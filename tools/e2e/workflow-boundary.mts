...
function validateExactPrManagedImageCatalogBoundary(
  ...
  if (
    managedCatalog?.if !==
      "${{ inputs.checkout_sha != '' && inputs.checkout_sha != 'ad7af27ec78d6222ceb7d3223e643adcdc2a6adf' && (inputs.jobs != 'native-runtime-qualification-producer' || inputs.targets != '') }}" ||
  ...
  if (
    reusedManagedCatalog?.if !==
      "${{ inputs.checkout_sha == 'ad7af27ec78d6222ceb7d3223e643adcdc2a6adf' && (inputs.jobs != 'native-runtime-qualification-producer' || inputs.targets != '') }}" ||
