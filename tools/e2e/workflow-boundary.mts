...
function validateExactPrManagedImageCatalogBoundary(
  ...
  if (
    managedCatalog?.if !==
      "${{ inputs.checkout_sha != '' && (inputs.checkout_sha != '933f105eb370acd42c5dc625548efe18ffd07e01' || inputs.jobs != '' || inputs.targets != 'model-router-provider-routed-inference,onboard-resume,onboard-repair') && (inputs.jobs != 'native-runtime-qualification-producer' || inputs.targets != '') }}" ||
