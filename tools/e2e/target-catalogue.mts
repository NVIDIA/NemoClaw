...
export const E2E_TARGET_CATALOGUE: readonly E2eCatalogueTarget[] = [
  ...
  managedRuntimeTarget("sandbox-quarantine-openclaw", {
    displayName: "Quarantine: OpenClaw stops exact runtime and denies restart",
    agentRuntime: "openclaw",
    environmentOrInferenceEndpoint: "Ubuntu; NVIDIA hosted inference",
    profile: "nvidia-inference",
    prAdvisorSelectable: true,
    ...
    environment: {
      ...
      NEMOCLAW_POLICY_TIER: "open",
      NEMOCLAW_RECREATE_SANDBOX: "1",
      NEMOCLAW_SANDBOX_NAME: "e2e-q-openclaw",
      OPENSHELL_GATEWAY: "nemoclaw",
    },
  }),
  managedRuntimeTarget("sandbox-quarantine-hermes", {
    displayName: "Quarantine: Hermes stops exact runtime and denies restart",
    agentRuntime: "hermes",
    environmentOrInferenceEndpoint: "Ubuntu; NVIDIA hosted inference",
    profile: "nvidia-inference",
    prAdvisorSelectable: true,
    ...
    environment: {
      ...
      NEMOCLAW_POLICY_TIER: "open",
      NEMOCLAW_RECREATE_SANDBOX: "1",
      NEMOCLAW_SANDBOX_NAME: "e2e-q-hermes",
      OPENSHELL_GATEWAY: "nemoclaw",
    },
  }),
  managedRuntimeTarget("sandbox-quarantine-langchain-deepagents-code", {
    displayName: "Quarantine: Deep Agents Code stops exact runtime and denies restart",
    ...
    environment: {
      ...
      NEMOCLAW_POLICY_TIER: "open",
      NEMOCLAW_RECREATE_SANDBOX: "1",
      NEMOCLAW_SANDBOX_NAME: "e2e-q-dcode",
      OPENSHELL_GATEWAY: "nemoclaw",
    },
  }),
