...
export const HERMES_DASHBOARD_JOB_TIMEOUT_MINUTES =
  HERMES_E2E_TEST_TIMEOUT_MINUTES + HERMES_TIMEOUT_HEADROOM_MINUTES;
export const HERMES_DASHBOARD_JOB_TIMEOUT_MAX_MINUTES =
  HERMES_E2E_TEST_TIMEOUT_MINUTES + HERMES_TIMEOUT_HEADROOM_MAX_MINUTES;
...
export const HERMES_TIMEOUT_CONTRACTS = [
  ...
  },
  {
    ...
    jobTimeoutMinutes: HERMES_DASHBOARD_JOB_TIMEOUT_MINUTES,
  },
  {
