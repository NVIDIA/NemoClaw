...
export type RiskSignalCounts = Pick<E2eRiskSignal, "passed" | "failed" | "skipped" | "pending">;
...
function mergeSignal(previous: E2eRiskSignal | null, current: E2eRiskSignal): E2eRiskSignal {
  ...
  if (
    ...
    throw new Error("risk signal metadata changed between invocations");
  }
  return {
    ...current,
...
export function writeRiskSignalCounts(
  ...
  unhandledErrors: number,
  runReason: E2eRiskSignal["runReason"],
): E2eRiskSignal {
