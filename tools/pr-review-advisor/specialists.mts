...
const RESPONSIBILITIES: Record<AdvisorInterest, string> = {
  ...
  "design-architecture":
    "Treat code growth as suspect. Account for total code, tests, fixtures, configuration, workflow, owners, and concepts. Compare direct modification, reuse, consolidation, replacement, and deletion. Demand a present consumer and concrete reduction before accepting new abstractions or machinery; preserve correctness, clarity, evidence, safety, and trust boundaries.",
  operations:
