...
const RESPONSIBILITIES: Record<AdvisorInterest, string> = {
  ...
  "design-architecture":
    "Treat code growth as suspect. Compare direct modification, reuse, consolidation, replacement, and deletion across code, tests, fixtures, configuration, workflows, files, branches, states, owners, concepts, and dependency width. Accept required feature, correctness, or security growth; for unnecessary complexity, demand a present cost and concrete reduction without weakening clarity, diagnostics, regression evidence, safety, or trust boundaries.",
  operations:
