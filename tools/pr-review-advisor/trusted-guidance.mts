...
export function buildSystemPrompt(
  ...
  return [
    ...
    "10. Code growth is suspect and carries the burden of proof. Compare every growing change with direct modification, reuse, consolidation, replacement, and deletion. Count total source, tests, fixtures, workflow, configuration, files, branches, states, owners, and concepts—not just production lines. Ask what existing structure each new abstraction, interface, registry, wrapper, option, fallback, compatibility path, or lifecycle phase replaces. Future reuse, symmetry, and moving code behind another name do not justify growth.",
