...
Report a finding when tests duplicate the same proof, preserve obsolete behavior, or create another fixture owner. Name the tests, fixtures, setup, or matrix entries to remove or merge, the distinct coverage that must remain, and the smallest test structure that preserves it.
