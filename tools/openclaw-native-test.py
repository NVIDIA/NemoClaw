...
def main():
    ...
    for phase in ("configure", "recreate"):
        ...
        run(
            ...
            "--mount",
            f"type=bind,source={ROOT}/test/openclaw_cli_driver.mts,target=/cli-driver.mts,readonly",
            "--mount",
            f"type=bind,source={ROOT}/test/openclaw_fixture_transport.mts,target=/fixture-transport.mts,readonly",
            "--mount",
    ...
    proof = {
        ...
        "source_sha256": {
            ...
            for name in (
                ...
                "test/openclaw_cli_driver.mts",
                "test/openclaw_fixture_transport.mts",
