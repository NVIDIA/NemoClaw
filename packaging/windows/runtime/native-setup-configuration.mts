...
export async function configureNativeFromStdin(
  ...
  dependencies: {
    inspectModel?: typeof inspectPrebuiltNativeModel;
    acquireState?: typeof acquireNativeStateSession;
  ...
  const state = await (dependencies.acquireState ?? acquireNativeStateSession)(
    launcher,
    normalized.agent,
  );
  try {
