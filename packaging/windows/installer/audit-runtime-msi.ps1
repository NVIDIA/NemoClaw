...
try {
    ...
    $msiOwned = 'NEMOCLAW_BUNDLE_MANAGED_RUNTIME <> "1"'
    $installCommit = 'NOT UPGRADINGPRODUCTCODE AND NOT (REMOVE ~= "ALL") AND ' + $msiOwned
    $removeCommit = 'NOT UPGRADINGPRODUCTCODE AND REMOVE ~= "ALL" AND ' + $msiOwned
