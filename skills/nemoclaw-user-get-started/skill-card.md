...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers use this skill to onboard, install, and launch a NemoClaw sandbox for the first time, including prerequisite verification, Windows WSL preparation, and Hermes agent setup. <br>
...
- [Quickstart with Hermes](references/quickstart-hermes.md) <br>
