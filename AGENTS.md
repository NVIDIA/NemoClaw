...
- Resolve the contributor's open PR limit from `.github/pr-limits.yaml`: use the lowercase GitHub username entry when present, otherwise use `default`; `unlimited` has no limit
