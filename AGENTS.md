...
- After the review, complete the PR template's Documentation Writer Review section. Record the result, evidence, agent surface, reviewed PR SHA, and current `AGENTS.md` blob SHA.
- If implementation changes after the recorded PR SHA, rerun the documentation writer review and refresh the receipt.
