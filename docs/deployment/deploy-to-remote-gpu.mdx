...
When you run `nemoclaw` over SSH, the install summary and `nemoclaw <sandbox> dashboard-url` print this command for you with the detected host and port. Then open the dashboard URL on your workstation.
