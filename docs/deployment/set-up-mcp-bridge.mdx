...
The launcher validates canonical HTTPS endpoints and exact OpenShell credential placeholders, then supplies an immutable snapshot across Deep Agents Code server starts and restarts.
