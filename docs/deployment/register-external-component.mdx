...
NemoClaw has not qualified the complete version 2 onboarding lifecycle against a released OpenShell runtime.
Do not rely on version 2 in an installed release.
...
Refer to [Switch Inference Providers](../inference/manage-inference/switch-providers) for the route requirements and verification behavior.
