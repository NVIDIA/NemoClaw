...
Managed-image pull and startup, an explicit custom Dockerfile build when selected, the Docker daemon, and the OpenShell gateway can exhaust a smaller host during onboarding.
