...
When a source has a narrower scope than the established OpenClaw, Hermes, and Deep Agents shared set, or appears in the Pi guide, its frontmatter declares the exact subset:
