...
It discards blank lines immediately inside the opening and closing tags so wrapper formatting does not split an adjacent Markdown list or paragraph, while preserving blank lines within the retained content.
