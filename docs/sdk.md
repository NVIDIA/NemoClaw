...
Onboarding and planning use the same assessment, preserving missing capability contracts as unknown.
...
The authoring library consumes Fabric's schemas to ask native setting questions, including conditional required fields.
Unsupported schema shapes remain unresolved instead of being guessed.
It preserves supplied public Fabric configuration outside the edited settings.
The [onboarding guide](../examples/onboarding-tui/README.md#guided-choices) describes its deployment subset.
