...
- [Fix Tool-Calling Failures](../inference/validate-and-troubleshoot/fix-tool-calling-failures) when the model emits a tool call as assistant text instead of structured output.
</AgentOnly>
