...
Managed Qwen 3.5 Local Ollama routes for `qwen3.5:9b` and `qwen35-9b-q6:latest` also disable Tool Search and expose direct tools.
Their compatibility profile keeps thinking off to preserve visible replies after mutating tool calls.
