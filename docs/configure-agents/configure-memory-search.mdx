...
nemoclaw my-assistant exec -- \
  ...
  '{"api":"ollama","baseUrl":"http://host.openshell.internal:11434","apiKey":"x","models":[{"id":"qwen3-embedding:4b","name":"Qwen3 embedding 4B"}]}' \
  --strict-json \
  --merge

nemoclaw my-assistant exec -- \
  openclaw config set agents.defaults.memorySearch.provider ollama-mem
