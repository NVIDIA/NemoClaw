...
The installer records a pending automatic port under its port-scoped state root before onboarding runs or is deferred, and promotes it after successful installer-driven onboarding.
