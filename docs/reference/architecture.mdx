...
Refer to [Configure Experimental Runtime Identity](configure-runtime-identity) for the trust boundary, Okta reference profile, apply lifecycle, inspection, and rollback behavior.
</AgentOnly>
