...
That Kubernetes resource path is a legacy implementation detail of the non-Docker-driver gateway; it is not present in the default Docker-driver topology.
