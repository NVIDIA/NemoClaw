...
The host update does not self-update Pi inside a running sandbox. Rebuild selects the reviewed Pi package and exact image associated with the installed NemoClaw release.
