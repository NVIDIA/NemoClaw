...
If native sandbox creation, readiness, or GPU verification reports a hard failure, onboarding saves redacted diagnostics and removes the incomplete sandbox before it retries through the compatibility path.
