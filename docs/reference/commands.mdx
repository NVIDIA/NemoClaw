...
Onboarding recognizes one proof-backed GPU whose bounded NVIDIA identity contains `RTX Spark N1X`, verifies the remaining N1x readiness requirements, and automatically selects the Experimental managed Qwen 3.6 recipe.
