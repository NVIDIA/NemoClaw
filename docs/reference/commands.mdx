...
Recovery pins the container identity and preserves the existing writable-layer state.
Before starting the host forward, it requires:

- Managed gateway health.
- A successful settle check.
- OpenShell readiness.
