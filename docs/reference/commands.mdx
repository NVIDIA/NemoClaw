...
NemoClaw verifies each service before it records the attachment.
...
`$$nemoclaw <name> doctor` reports the attachment state and the three capability health results.
