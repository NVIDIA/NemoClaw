...
```text
...
    Agent:    LangChain Deep Agents Code v0.1.30
...
```
...
For Deep Agents sandboxes, prefer `$$nemoclaw onboard --resume --recreate-sandbox` when you need to change the provider or model.
