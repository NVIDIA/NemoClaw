...
Supported sandboxes use hosted external inference, including NVIDIA Endpoints through OpenShell's built-in NVIDIA profile, an immutable managed image, a NemoClaw-owned gateway, and an explicit representable policy.
