...
For a Podman sandbox, `recover` delegates to the registered runtime provider.
The provider restarts a running managed container or starts a stopped managed container without changing its identity.
