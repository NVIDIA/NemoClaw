...
If you cancel a brand-new onboarding run at the policy preset step, NemoClaw preserves the incomplete sandbox, registry entry, and onboarding session for identity-bound recovery.
