...
Sandbox-create failure bundles contain bounded, redacted gateway and rootfs-console output when available for the verified sandbox ID. Review runtime diagnostics before sharing.
