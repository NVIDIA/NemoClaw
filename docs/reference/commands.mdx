...
If onboarding cannot complete after sandbox creation, NemoClaw preserves the sandbox, records its create-attempt label, and prints the exact `ai.nvidia.nemoclaw.create-attempt=<value>` selector.
