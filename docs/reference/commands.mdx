...
Supported sandboxes use OpenAI, Anthropic, or native NVIDIA hosted inference with NVIDIA's default endpoint, an immutable managed image, a NemoClaw-owned gateway, and an explicit representable policy.
