...
If that deletion succeeds, the sandbox is removed with its unguarded config; if it fails, the config stays unlocked until you delete or rebuild the sandbox.
