...
The request contains only the recorded runtime, policy, inference, target, and capability identities.
...
NemoClaw clears it after target reset, detach, destroy, identity change, or failed target health validation.
