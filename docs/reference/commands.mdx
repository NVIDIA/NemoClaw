...
For an already published sandbox on the gateway selected in the current session's checkpoint, it can clear a foreign pending reservation while retaining the published sandbox data.
