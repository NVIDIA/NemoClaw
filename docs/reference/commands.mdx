...
It preserves both the pre-release receipt and the final released receipt before it clears the fence.
A receipt write failure or changed target authority stops release and leaves the fence active for retry.
