...
Sandboxes that are not running are skipped with remediation guidance.
...
When strict mode reports a skipped stopped sandbox, start that sandbox or its container and rerun the installer or `$$nemoclaw backup-all`.
