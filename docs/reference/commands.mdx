...
Managed OpenClaw and Hermes exports use `image: null` until v1 supplies the value.
The unreleased v1 parser is not an acceptance gate for this staged output.
