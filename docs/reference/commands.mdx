...
The recommended profile appears as **Managed llama.cpp: NVIDIA Nemotron 3 Nano 30B-A3B on one DGX Spark (recommended)**.
The Meta Muse Glimmer profile remains available without the recommendation marker.
