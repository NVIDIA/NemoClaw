...
If onboarding cannot complete after sandbox creation, NemoClaw preserves the sandbox and records its immutable identity and verified policy evidence for recovery.
