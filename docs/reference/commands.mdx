...
When you combine them, `doctor` exits before it runs checks, writes one JSON error envelope to standard output, and names the conflicting flags on standard error.
