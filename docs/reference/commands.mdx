...
This includes native NVIDIA hosted inference when OpenShell reports its unmodified built-in NVIDIA profile.
Custom NVIDIA profiles or endpoint overrides are not exportable.
