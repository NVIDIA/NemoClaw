...
Do not combine `--json` and `--text`.
The command exits before it runs checks, writes a JSON error to standard output, and reports the flag conflict on standard error.
