...
The scope comes from the exact preset YAML and includes each endpoint's host, port, access or protocol settings, allowed methods and paths, and binary allowlist.
