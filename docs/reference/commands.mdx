...
| `NEMOCLAW_OPENSHELL_STANDALONE_INSTALL` | `1` to enable | Advanced fallback that skips the upstream Linux OpenShell package/service installer and installs standalone release binaries instead. |
