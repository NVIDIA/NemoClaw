...
| `$$nemoclaw internal installer telemetry <install\|update>` | `install.sh` | Pass one closed successful operation to the shared telemetry client. Production delivery remains disabled until its configuration is provisioned. |
