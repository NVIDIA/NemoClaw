...
When the removal itself fails, the command reports the path that is still listed and asks you to remove it before the next restore, and the exit code stays nonzero.
