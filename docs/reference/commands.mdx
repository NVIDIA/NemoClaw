...
If an ordinary restart changes the token without replacing the sandbox, collect the before and after sandbox identity plus redacted mint logs and report it as a bug.
