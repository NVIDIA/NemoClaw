...
The external Gabby integration owns each source file's location and lifetime, while the identity lifecycle from #8403 owns replacement, removal, and revocation.
