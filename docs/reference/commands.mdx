...
On those Docker hosts, catalog or registry resolution failures stop stock onboarding before mutation.
...
Native Podman is not supported by this release; use Docker Engine, Docker Desktop, or Colima.
