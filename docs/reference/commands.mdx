...
| Flag | Description |
|------|-------------|
| `--agent <id>` | Agent id when `<key>` is an alias rather than the canonical `agent:<id>:<rest>` form. Omit the flag to address the default `main` agent. |
...
| Flag | Description |
|------|-------------|
| `--agent <id>` | Agent id when `<keys>` are aliases rather than the canonical `agent:<id>:<rest>` form. Omit the flag to address the default `main` agent. |
