...
If no provider is requested or recorded and `NEMOCLAW_MODEL` remains unset, a compatible `NEMOCLAW_LLAMACPP_RECIPE` value selects managed llama.cpp and makes its recipe explicit.
