...
Names must be 1 to 19 characters, lowercase, start with a letter, contain only letters, numbers, and internal hyphens, and end with a letter or number.
...
The same name format and reserved-name rules that the wizard enforces apply here too. Names must be 1 to 19 characters, lowercase, start with a letter, contain only letters, numbers, and internal hyphens, and end with a letter or number.
