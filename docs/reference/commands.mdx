...
Hermes export also requires the default API configuration, a disabled dashboard, no Hermes tool gateways, and no Hermes-specific authentication settings.
Other profiles fail with a diagnostic instead of producing an incomplete document.
