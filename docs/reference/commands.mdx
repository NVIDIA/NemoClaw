...
Hermes Portable Ollama keeps an independently journalled unfinished gateway-provider transaction eligible for exact recovery as described under [`--resume` and `--fresh`](#--resume-and---fresh).
