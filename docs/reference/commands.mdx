...
When participating metadata is missing, invalid, conflicting, or has an invalid gateway binding, both formats retain the provider and model without adding endpoint details.
