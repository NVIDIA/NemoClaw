...
Sandbox-create failure bundles contain bounded gateway and rootfs-console output for the verified sandbox ID. They are not automatically redacted; review them for sensitive runtime output before sharing.
