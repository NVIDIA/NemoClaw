...
The export rejects the complete document when any secondary agent has a model that differs from the primary model, unsupported tools, execution settings, a primary-agent override, or a default subagent setting.
