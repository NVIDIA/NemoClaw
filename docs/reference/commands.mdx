...
The equivalent environment variable is `NEMOCLAW_FORCE_FRESH_INSTALL=1`. The installer rejects this option on non-macOS hosts and stops without deleting remaining state if the authoritative whole-host uninstall cannot complete.
