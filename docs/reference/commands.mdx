...
NemoClaw validates the complete three-agent publication cohort before selecting any member and stops before sandbox creation when the cohort is unavailable, incomplete, mixed, mutable, or incompatible.
The stock path does not build a Dockerfile.
