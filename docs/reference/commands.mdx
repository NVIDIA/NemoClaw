...
The interactive takeover makes up to 7 restoration attempts.
The detached auto-restore timer makes up to 7 total recovery attempts across deadline setup and restoration.
Both paths wait 5 seconds between failed attempts, for up to 30 seconds of retry delay.
