...
NemoClaw records the new intent before it applies the generated OpenShell policy.
If policy activation fails, run `$$nemoclaw <name> mcp restart <server>` to converge to the recorded intent.
