...
The v0 command projects verified source state into a pre-release v1alpha1 YAML shape with one
singular `agent`. Managed OpenClaw and Hermes exports use `image: null` until v1 supplies the value.
