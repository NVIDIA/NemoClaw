...
`DOCKER_CONTEXT` selects the Docker authority the same way `DOCKER_HOST` does, and NemoClaw never replaces a selected context with a discovered fallback socket.
