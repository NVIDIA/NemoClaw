...
If the probe times out or cannot start, NemoClaw keeps the selected authority and reports `docker_probe_inconclusive` with a command to verify that authority.
