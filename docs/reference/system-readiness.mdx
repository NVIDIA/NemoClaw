...
| `host.platform.n1x` | N1x identity from the trusted FastOS marker and an NVIDIA display-class PCI device on Linux ARM64 with an available NVIDIA GPU. This capability does not promote the Deferred platform status. |
