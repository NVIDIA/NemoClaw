...
Onboarding rejects a value outside that range, and it applies an in-range value without checking whether another sandbox or a host listener already holds it.
