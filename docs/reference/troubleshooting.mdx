...
Complete the normal pairing flow for each browser or CLI device. For the security model, refer to [Gateway Authentication Controls](../security/security-controls/gateway-authentication-controls).
