...
Docker-driver gateways on OpenShell 0.0.82 reject `NEMOCLAW_GATEWAY_BIND_ADDRESS=0.0.0.0` while gateway JWT auth is active.
...
OpenShell 0.0.82 directly supports Linux hosts with glibc 2.28 or newer.
