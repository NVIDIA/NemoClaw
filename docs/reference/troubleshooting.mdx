...
| --- | --- | --- |
| Socket authority | The recorded socket is unsafe, another authority field changed, or its inode was replaced more than once during cold activation. | Stop and inspect the reported path. Restore the recorded current-user runtime instead of selecting another endpoint. |
