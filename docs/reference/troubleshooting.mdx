...
The affected sandboxes use that route until another onboarding run or `$$nemoclaw <name> connect` warns and re-points it.
...
Onboarding and connect intentionally provide the time-shared route-switching path.
