...
When NemoClaw confirms that it saved the record, run `$$nemoclaw <sandbox-name> destroy` and follow [Recover a retained sandbox](commands#recover-a-retained-sandbox) for the result-specific recovery steps.
