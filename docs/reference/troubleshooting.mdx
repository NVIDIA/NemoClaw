...
For a server detected on `localhost:8000`, select the **Local vLLM [experimental]** entry marked **running (suggested)**; for another address, select **Other OpenAI-compatible endpoint**.
