...
The default installer and an explicit `NEMOCLAW_INSTALL_TAG=lkg` selection stop before replacing a newer installed NemoClaw release. An intentional downgrade requires an immutable older tag or ref.
