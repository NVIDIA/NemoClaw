...
Credential isolation is different: if NemoClaw confirms that the raw Brave or Tavily key is visible in the sandbox environment, onboarding reports a security error and does not mark the sandbox as ready.
