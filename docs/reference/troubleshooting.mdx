...
The terminal output also preserves the create-attempt evidence, but a recovery-only session remains blocked until NemoClaw can save the durable recovery record.
