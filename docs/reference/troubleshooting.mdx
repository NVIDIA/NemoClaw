...
### Snapshot Creation Reports a Required Python Interpreter
...
The message covers these commands:

- `$$nemoclaw <name> snapshot create`
- `$$nemoclaw <name> rebuild`
- The backup that maintenance takes before it changes sandbox state
- The backup that NemoClaw takes for a stopped sandbox
