...
1. Check the managed OpenShell gateway service.
   ...
   If `brew info --json=v2 openshell` returns the exact pinned-formula untrusted-tap refusal, onboarding prints the recognized diagnostic once without repeating raw Homebrew output.
