...
For environment setup steps, see [Windows Prerequisites](../get-started/windows-preparation.mdx).
...
For additional troubleshooting, see the [Quickstart](../get-started/quickstart.mdx) and [Windows Setup](../get-started/windows-preparation.mdx) pages.
...
For setup, refer to [Quickstart with Hermes](../get-started/quickstart-hermes.mdx).
...
The Hermes wizard intentionally omits the Brave Search preset because Hermes does not use NemoClaw's OpenClaw web-search configuration (see [Quickstart with Hermes](../get-started/quickstart-hermes.mdx) and [Network Policies](network-policies.mdx)).
