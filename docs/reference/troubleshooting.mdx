...
The configuration review shows a local build-time estimate only for an explicit custom Dockerfile or after NemoClaw has selected the trusted Dockerfile fallback.
