...
### NemoClaw Reports an Incomplete Installation

If NemoClaw reports that its compiled CLI is missing or incomplete, an install or upgrade did not finish.
Rerun the installer command that you used to install NemoClaw.
The installer attempts to finish installation and recover existing sandboxes.
Follow any recovery guidance that the installer reports.
