...
On ARM64 Linux hosts that are native or Docker Desktop-backed WSL, onboarding clears a placeholder name with one bounded Docker CUDA workload before rejecting the GPU:
