...
For OpenClaw, both that compatibility recreation and a managed native recreation propagate eligible host group IDs for the supported Jetson GPU device nodes.
