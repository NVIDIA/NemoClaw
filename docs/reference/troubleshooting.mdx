...
If the release proof does not arrive after the rollback container has been removed, NemoClaw leaves the replacement stopped and reports that automatic rollback is unavailable.
