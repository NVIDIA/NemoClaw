...
Sandbox names must use 1 to 19 characters, be lowercase, start with a letter, contain only letters, numbers, and internal hyphens, and end with a letter or number.
