...
Before full uninstall deletes shared state, it removes only a authenticated host-local vLLM container and NemoClaw-owned llama.cpp container and network.
