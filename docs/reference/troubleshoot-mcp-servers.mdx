...
The command reads OpenClaw gateway output and OpenShell audit events, so policy denials appear beside gateway logs.
</AgentOnly>
<AgentOnly variant="hermes">
The command reads Hermes gateway output and OpenShell audit events, so policy denials appear beside gateway logs.
</AgentOnly>
<AgentOnly variant="deepagents">
The command reads Deep Agents sandbox output and OpenShell audit events, so policy denials appear beside sandbox logs.
</AgentOnly>
