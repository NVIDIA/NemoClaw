...
The critical `managed_inference` entry cannot be excluded because it carries the required route to managed inference. NemoClaw enforces this both when the command runs and whenever durable exclusion state is replayed.
