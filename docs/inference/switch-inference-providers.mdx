...
If a registered same-gateway sandbox lacks durable provider or model metadata, NemoClaw fails closed until you remove and re-onboard that sandbox with complete route metadata.
