...
If Portable onboarding reports that the `openshell-docker` network still uses the retired `169.254.1.0/24` subnet, remove that network, then rerun Portable onboarding:
