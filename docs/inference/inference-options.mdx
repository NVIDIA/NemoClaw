...
If you change providers or models for an existing Deep Agents sandbox, prefer `nemo-deepagents onboard --resume --recreate-sandbox` so NemoClaw rewrites the config and route together.
</AgentOnly>
