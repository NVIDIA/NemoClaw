...
Destroying a sandbox deletes its persistent state volume.
...
After you destroy all sandboxes, uninstall NemoClaw to stop the adapter and purge its in-memory credentials.
