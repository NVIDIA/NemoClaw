...
The adapter accepts route requests only from loopback or those inspected subnets and returns a not-found response to peers on other private or LAN networks.
