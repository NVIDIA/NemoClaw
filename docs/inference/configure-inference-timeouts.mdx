...
| `NEMOCLAW_SANDBOX_READY_TIMEOUT` | Image build, gateway upload, and in-sandbox boot after creation; OpenShell re-registration after OpenClaw or Hermes managed recovery recreation | `180` seconds |
