...
| `NEMOCLAW_SANDBOX_READY_TIMEOUT` | OpenShell publication, durable identity settlement, and executable readiness after creation | `180` seconds |
...
If this deadline expires, NemoClaw preserves the sandbox and records recovery evidence when possible.
