...
On WSL2, increase `NEMOCLAW_ONBOARD_VALIDATION_TIMEOUT_SECONDS` when an OpenAI-compatible provider validation request times out before the provider replies.
