...
A qualifying Windows WSL N1x host instead selects the managed Qwen llama.cpp recipe automatically during Windows Express or non-interactive onboarding with no requested or recorded provider.
</Warning>
