...
The profile rejects `NEMOCLAW_VLLM_MODEL`, `NEMOCLAW_VLLM_EXTRA_ARGS_JSON`, and `NEMOCLAW_MANAGED_CLUSTER_PEERS` before installation.
If you set `NEMOCLAW_SERVING_PRESET`, it must match the fixed profile's catalog preset.
