...
Refer to [Set Up Ollama](local-inference/set-up-ollama).
</AgentOnly>
...
Refer to [Set Up vLLM](local-inference/set-up-vllm).
...
Refer to [Set Up NVIDIA NIM](local-inference/set-up-nvidia-nim).
...
- [Verify the Inference Route](validate-and-troubleshoot/verify-inference-route) after onboarding.
