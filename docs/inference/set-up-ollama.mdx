...
On a WSL RTX Spark N1x, NemoClaw can select an installed `qwen3.6:35b` only when the Windows product identity qualifies and the same Docker CUDA proof reports at least 30,000 MiB available.
