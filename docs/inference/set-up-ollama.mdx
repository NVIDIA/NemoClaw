...
- [Choose a Local Inference Server](../local-inference) to compare local options.
...
<AgentOnly variant="openclaw">
- [Fix Tool-Calling Failures](../validate-and-troubleshoot/fix-tool-calling-failures) when a model emits tool calls as text.
</AgentOnly>
