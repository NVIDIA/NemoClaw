...
The Nemotron 3 Super catalogue minimum includes NIM's reported runtime allocation.
...
When onboarding detects this warning in recent NIM logs, it ends the health wait before the 1,200-second timeout and selects NVIDIA Endpoints.
