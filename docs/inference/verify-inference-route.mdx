...
If this check fails after compatibility recreation, onboarding attempts to print failure diagnostics, reports when diagnostics are unavailable, and then attempts to restore the pre-patch container before it exits.
