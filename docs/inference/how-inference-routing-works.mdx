...
title: "How Inference Routing Works"
sidebar-title: "How Routing Works"
...
- [Choose an Inference Provider](choose-inference-provider) compares the upstream routes that OpenShell can use.
...
- [Verify the Sandbox Inference Route](../validate-and-troubleshoot/verify-inference-route) tests the configured path.
