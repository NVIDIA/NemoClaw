...
If another process holds the configured single-host port, NemoClaw usually stops the managed install before it persists a bearer key or records the selected model.
