...
On N1x, the entry for an already-running server has no status label.
Only the managed **Install vLLM** or **Start vLLM** entry carries the **Deferred preview** label.
