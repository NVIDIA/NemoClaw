...
The pinned model and runtime were validated on one DGX Spark for text, separated reasoning, structured tool calls, and an OpenClaw chat turn without fallback.
...
| `muse-glimmer-30b` | `Inferact/Muse-Glimmer-30B-NVFP4-W4A4` | DGX Spark | `12.1` | Additional single-DGX Spark choice configured for text, reasoning, and structured tool calls. |
