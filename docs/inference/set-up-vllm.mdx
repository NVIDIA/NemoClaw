...
| `nemotron-3.5-lightning-30b` | `nvidia/NVIDIA-Nemotron-3.5-Lightning-30B-A3B-NVFP4` | Compatible Linux `amd64` NVIDIA GPU | `8.0` | Experimental explicit-only Linux baseline. Use the stable catalog profile ID on DGX Spark. |
