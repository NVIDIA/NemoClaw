...
- DGX Spark and DGX Station use the `linux/arm64` digest `sha256:9204569b17ee4c0eff75194b8e6e458479c8aee18953b5ab9cf359fcdac659e2` with a published compressed size of `8.94 GB` under `nvcr.io/nvidia/vllm:26.05.post1-py3`.
- Generic Linux `arm64` hosts use `sha256:447995cbb57e6c7cf792cab95e9852e5f62b5fb6d2f39e030fa4eda9a54eadb4` with a published compressed size of `8.64 GB` under `nvcr.io/nvidia/vllm:26.03.post1-py3`.
- Generic Linux `amd64` hosts use `sha256:7be6c2f676c36059a494fe17254e69ae5c677535ba6191044e5fc8e42a91c773` with a published compressed size of `8.32 GB` under `nvcr.io/nvidia/vllm:26.03.post1-py3`.
