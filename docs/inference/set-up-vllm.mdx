...
No stock DGX OS release is currently qualified for this path.
On DGX OS 7.5, managed vLLM, inference, tool use, and restart/reuse passed, but CUDA initialization segfaulted inside the real OpenShell sandbox.
Use the generic Ubuntu 24.04 ARM64 control for the Station express path and follow [NVIDIA/OpenShell#2343](https://github.com/NVIDIA/OpenShell/issues/2343) for DGX OS requalification.
</Warning>
