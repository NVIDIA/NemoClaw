...
A definite failure leaves the provider binding unchanged.
...
If NemoClaw cannot restore the previous selection, do not use the route until you rerun onboarding.
