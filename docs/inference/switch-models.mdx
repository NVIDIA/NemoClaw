...
During custom-image startup, if the OpenClaw configuration still names a different model ID than the host-selected route, NemoClaw removes both inherited values while it reconciles that stale configuration.
