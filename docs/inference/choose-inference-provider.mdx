...
| Local llama.cpp managed install | A qualified DGX Spark, Linux x86_64 NVIDIA GPU, or Windows WSL N1x host satisfies the declarative recipe requirements. | [Set Up llama.cpp](../local-inference/set-up-llama-cpp) |
