...
On a qualifying Windows WSL N1x host, Windows Express and non-interactive onboarding with no requested or recorded provider, `NEMOCLAW_MODEL`, or managed-recipe override automatically select managed llama.cpp after Docker Desktop GPU passthrough succeeds.
