...
<Warning>
On native N1x FASTOS, accept the Deferred managed-vLLM preview or enter standard onboarding by declining Express, disabling Express without an excluded provider, or setting a recognized `NEMOCLAW_PROVIDER` value other than Local NVIDIA NIM.
