...
To reconcile the whole roster against a manifest in one step, use `nemoclaw <name> agents apply`, described in [Apply to an Existing Sandbox](#apply-to-an-existing-sandbox).
