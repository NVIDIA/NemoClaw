...
NemoClaw reserves `main` for the primary agent, which continues to use the default workspace; secondary named agents use suffixed workspaces. For example, a Teams-integrated deployment can use the primary `main` agent plus per-user agents.
