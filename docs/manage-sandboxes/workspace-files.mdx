...
The direct Docker topology with separate gateway and sandbox users retains `/tmp/.gitconfig` because the gateway cannot create files in the sandbox-owned home.
