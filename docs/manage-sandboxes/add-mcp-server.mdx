...
Managed MCP also verifies that the selected host OpenShell gateway was launched from a private configuration that does not enable `proxy_connect_by_hostname`.
