...
NemoClaw pins the child-visible compatibility list to OpenShell `v0.0.99` commit `8c7dd148a9e6360c9d5b2830e339a0dc4b3f3032`.
...
OpenShell `v0.0.99` has a trusted-gateway branch for a narrow driver-provided topology, but it does not expose an attested driver gateway address that NemoClaw can pin for this flow.
