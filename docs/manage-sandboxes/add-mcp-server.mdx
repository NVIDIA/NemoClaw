...
Until a successful `mcp restart` refreshes the public pins, any later DNS answer outside the addresses returned during public preflight remains unpinned and fails closed.
