...
NemoClaw removes only a volume whose ownership labels match NemoClaw's recorded labels; inspection or removal failure exits nonzero and preserves registry state for retry.
</Warning>
</AgentOnly>
