...
If onboarding used a custom state root, pass its original path and use the managed-gateway recovery procedure under [Uninstall Every Gateway Port](#uninstall-every-gateway-port).
