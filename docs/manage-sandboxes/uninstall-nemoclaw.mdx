...
When NemoClaw manages the local gateway, recorded Docker sandboxes require the Docker command for cleanup verification; restore the command before retrying if it is missing.
