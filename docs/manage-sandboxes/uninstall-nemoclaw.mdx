...
Valid gateways created before the state-root marker existed retain the same recovery path through their owner-private generated configuration and live process proof.
