...
An unexpected absence, same-name replacement, non-ready sandbox, changed container label set, provider revision or profile change, socket or network change, or registry authority drift stops cleanup before an unproven mutation.
