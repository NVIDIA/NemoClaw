...
When no Portable lifecycle receipt or retirement record exists, full uninstall preserves `~/.config/nemoclaw/portable/` unchanged and completes ordinary cleanup.
...
Inspect or remove the preserved path before a later Portable onboarding attempt.
