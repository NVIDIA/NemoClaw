...
If the selected state root contains a managed dual-Station cleanup receipt, NemoClaw first revalidates the recorded peer, cluster, and GPU identities and removes both exact managed vLLM containers.
