...
The upstream binary behind the wrapper is an internal implementation detail.
Direct invocation is unsupported and bypasses the compatibility refusal and the managed lifecycle.
