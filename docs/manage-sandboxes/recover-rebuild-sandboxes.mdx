...
<AgentOnly variant="openclaw,hermes">
The rebuild omits each stopped channel's inactive built-in messaging preset.
The rebuild preserves exact custom policies for separate replay, including a custom policy whose name matches a built-in messaging preset.
</AgentOnly>
