...
If state restore, managed MCP restoration, gateway replacement, agent-version verification, or cron validation fails after gate acquisition, the command exits nonzero and preserves the backup.
