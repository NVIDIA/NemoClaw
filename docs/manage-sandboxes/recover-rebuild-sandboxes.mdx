...
Portable Hermes records the gateway selected by `NEMOCLAW_GATEWAY_PORT`; recovery and uninstall use that recorded gateway, including a non-default gateway.
