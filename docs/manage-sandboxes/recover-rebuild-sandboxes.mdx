...
If state restore, managed MCP restoration, gateway replacement, or cron validation fails after gate acquisition, the command exits nonzero, preserves the backup, and retains the NemoClaw gate.
