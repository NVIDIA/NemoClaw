...
The `start` command returns success only after it authenticates the recovered agent runtime, OpenShell reports the sandbox ready, and required host forwards pass their checks.
