...
<AgentOnly variant="openclaw">
  ...
  changes survive sandbox replacement without a selective merge.
  Rebuild preserves restored OpenClaw session model and provider selections, including selections that differ from the configured default.
</AgentOnly>
