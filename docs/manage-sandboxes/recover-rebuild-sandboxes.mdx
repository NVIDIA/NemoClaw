...
NemoClaw keeps the container identity and writable state unchanged, then requires managed gateway health and OpenShell `Ready` before starting the primary dashboard or API host forward.
