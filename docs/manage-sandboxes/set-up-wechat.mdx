...
NemoClaw applies the WeChat plugin settings through OpenClaw's native configuration writer.
It changes the channel and plugin settings without replacing unrelated native configuration.
</AgentOnly>
