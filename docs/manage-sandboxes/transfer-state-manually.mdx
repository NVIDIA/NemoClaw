...
Startup migrates safe legacy files and WhatsApp session state into the native Hermes home, discards generated shadow configuration, and refuses conflicting or linked state without deleting it.
