...
Do not restore the retired pre-cutover `/sandbox/.deepagents/skills/` upload directory. Deep Agents Code never loaded it; the corresponding agent-owned copy is `/sandbox/.deepagents/agent/skills/`.
