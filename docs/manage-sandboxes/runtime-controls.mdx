...
Before a manual Shields transition replaces a policy, NemoClaw requires Model Context Protocol (MCP) agreement among the sandbox registry, generated-policy record, and live gateway policy.
