...
Durable containment, or the retained exact gates after a failed containment commit, keeps new mutations blocked until you complete exact-generation operator recovery.
