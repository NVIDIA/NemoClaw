...
On supported `amd64` Docker hosts, stock OpenClaw, Hermes, and Deep Agents onboarding prefers complete immutable release images.
...
If managed image resolution is unavailable, Docker uses the trusted canonical Dockerfile recipe as a fallback.
