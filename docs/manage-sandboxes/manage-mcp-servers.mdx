...
If the command or process stops after journaling, run `$$nemoclaw my-sandbox mcp restart doordash` to commit the journaled replacement and retry policy activation.
