...
The selected local webhook port must be free or belong to the current sandbox's active OpenShell forward.
An unrelated host process or another active Teams sandbox cannot share the port.
