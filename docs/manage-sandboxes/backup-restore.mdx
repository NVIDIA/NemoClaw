...
NemoClaw refuses unsafe paths and does not merge two populated profile directories.
...
If migration fails, NemoClaw marks the restore incomplete instead of reporting success.
</AgentOnly>
<AgentOnly variant="deepagents">
