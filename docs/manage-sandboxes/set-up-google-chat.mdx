...
- Minify the service-account JSON to one line before you paste it at the interactive prompt.
  `GOOGLECHAT_SERVICE_ACCOUNT` accepts the downloaded JSON with LF or CRLF line breaks when you set it in the host environment.
