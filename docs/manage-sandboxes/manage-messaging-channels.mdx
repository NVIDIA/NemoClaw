...
While a channel remains stopped, the rebuild omits its runtime configuration, token upsert, channel startup effects, and inactive built-in messaging preset.
