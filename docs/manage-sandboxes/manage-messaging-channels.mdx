...
<AgentOnly variant="hermes">
After `channels stop discord`, a Hermes rebuild keeps the existing Discord provider attached to the replacement sandbox because the policy references it.
The Discord channel remains disabled.
</AgentOnly>
