...
<AgentOnly variant="openclaw">
OpenClaw Google Chat recovery requires interactive `$$nemoclaw <sandbox> channels add googlechat` to configure its public webhook audience.
Rebuild the sandbox after enrollment, then retry `shields down`.
</AgentOnly>
