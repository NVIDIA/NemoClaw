...
| Google Chat | Service-account JSON | OpenClaw webhook and user IDs, or Hermes Pub/Sub subscription and email allowlist | [Set Up Google Chat](set-up-google-chat) |
...
Google Chat requires a service-account JSON key, a Google Cloud project ID, and a complete Pub/Sub subscription name for Hermes.
Use email addresses for the optional sender allowlist.
