...
NemoClaw tracks these aliases in messaging compatibility metadata with a one-release removal gate; keep them only until QA automation and public templates have stopped exporting them for at least one full release.
