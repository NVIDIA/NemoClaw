...
NemoClaw stages a validated snapshot, then Hermes imports, verifies, and activates the skill through its native lifecycle; this does not install Hermes runtime plugins.
