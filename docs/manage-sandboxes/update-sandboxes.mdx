...
On Linux, failed OpenShell lifecycle commands for the default gateway on port `8080` cause the installer to check a verified active service before a verified NemoClaw-managed gateway PID file.
