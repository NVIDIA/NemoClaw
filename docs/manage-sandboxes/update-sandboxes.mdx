...
Do not set `NEMOCLAW_OPENSHELL_UPGRADE_PREPARED=1` unless both commands succeed and the backup command reports that every registered sandbox backup and exact legacy-forward retirement completed.
