...
It uses the right NemoClaw docs and skills, helps you choose OpenClaw, Hermes, or Deep Agents one question at a time, handles credentials locally, and asks for approval before running commands.
