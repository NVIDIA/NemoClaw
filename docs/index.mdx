...
sidebar-title: "Home"
description: "NemoClaw is an open-source reference stack for running supported AI agents more safely with guided onboarding, managed inference, policy, and lifecycle operations."
...
NemoClaw provides guided onboarding, managed inference, network policy, managed integrations, and lifecycle operations for supported agent runtimes.
It installs OpenShell, part of NVIDIA Agent Toolkit, and applies the selected agent integration layer and versioned blueprint. OpenShell provides credential custody for managed inference and host-configured integration credentials.
