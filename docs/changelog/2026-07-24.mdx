...
- Live E2E validation now isolates long-running lanes, trusts Hermes swap setup for the PR SHA, stabilizes cancelled child lifecycles, parallelizes plugin EXDEV coverage, and records periodic runner-pressure telemetry.
