...
NemoClaw v0.0.101 adds experimental Google Chat support for OpenClaw and improves runtime status, failed-gateway cleanup, inference-route cleanup, backup safety, and Hermes messaging persistence.
...
- Documentation now clarifies Slack conflict detection across independent OpenShell gateways.
  ...
  The release also completes the durable documentation follow-ups identified after the v0.0.100 tag.
