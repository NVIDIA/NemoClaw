...
- Trusted CI now approves workflow runs only when the recorded commit matches the current PR head for eligible same-repository maintainers, provisions pinned search tools before untrusted CLI tests run, and reviews changed repository terminology.
