...
- Installer and onboarding checks now support protected Docker 27 receipt transfer and an explicit force-fresh macOS reset that retains model caches.
  Port overrides with leading zeroes fail before onboarding, Teams channel changes verify the selected webhook port before mutation or rebuild deletion, and Windows MXC rejects sandbox names longer than the OpenShell limit before provider creation.
  ...
  Related changes: [PR #12015](https://github.com/NVIDIA/NemoClaw/pull/12015), [PR #11875](https://github.com/NVIDIA/NemoClaw/pull/11875), [PR #10489](https://github.com/NVIDIA/NemoClaw/pull/10489), [PR #12052](https://github.com/NVIDIA/NemoClaw/pull/12052), [PR #12074](https://github.com/NVIDIA/NemoClaw/pull/12074), and [PR #12234](https://github.com/NVIDIA/NemoClaw/pull/12234).
