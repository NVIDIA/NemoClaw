...
- Managed DGX Spark llama.cpp onboarding now recommends NVIDIA Nemotron 3 Nano 30B-A3B.
  Meta Muse Glimmer remains available only by explicit selection, and existing Muse-owned installations are not migrated.
