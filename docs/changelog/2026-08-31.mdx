...
- Routine Hermes Portable `connect --probe-only` recovery now reuses a verified receipt-owned Ollama runtime and healthy forwards without repeating onboarding's full inference qualification.
  When that runtime or its forwards need recovery, NemoClaw keeps the existing ownership, readiness, route, and rollback checks.
  Related change: [PR #10614](https://github.com/NVIDIA/NemoClaw/pull/10614).
