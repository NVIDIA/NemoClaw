...
The legacy `launch-supervisor` action additionally requires the host-pinned registered container and legacy keepalive evidence.
The controller then repeats the absence proof before it launches anything.
