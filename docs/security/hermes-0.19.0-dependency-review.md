...
| `HERMES-12` | High | Pin and runtime-proof | Trusted workflow run `30776966524`, attempt 1, built source commit `25d83d5fd43be3bc8d423345810f67cea8fd2df2` and published amd64 digest `sha256:64351f151fe40eae3e307bc3e83d68d24ba1b4afcebdb7ee6ddcd48179db20e9` plus arm64 digest `sha256:6afbba833323b5366a7c494bbbf64831fabc721b652c5210b56dc71dad58804d` under OCI index `sha256:9cfcc45aae82396aed195975e6716bb52981760df13e0d638828486178f26536`. The final Dockerfile pins that index. Both base-image builds passed the exact-source patch guard, locked bridge install, and bridge-level proxy-agent regression test; live final-image WhatsApp evidence remains under `HERMES-22`. |
