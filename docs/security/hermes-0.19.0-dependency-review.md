...
| `HERMES-12` | High | Pin and runtime-proof | Trusted workflow run `30775216750`, attempt 2, built source commit `46396ba0ce2b97e1e6c00100735577aabc2a2c8d` and published amd64 digest `sha256:ba957d1e2b258830de9ce1339983c74c5548e0888384084718bb1823ead1fa33` plus arm64 digest `sha256:e50ed5898e8b0723d543a27eb343796ad97fa04c8d574aacfeb1db96484dee0d` under OCI index `sha256:c5e1ff555b6362d16ff439c7f409e5a6d6eab279b9fb5b23b6ac48a31f0db594`. The final Dockerfile pins that index. Both base-image builds passed the exact-source patch guard, locked bridge install, and installed proxy-agent constructor probe; protected final-image WhatsApp runtime evidence remains under `HERMES-22`. |
