...
title: "Configure Corporate CA Trust"
...
Configure a corporate CA before onboarding when an enterprise proxy re-signs external TLS with a root that OpenShell does not provide.
