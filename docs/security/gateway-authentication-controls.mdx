...
title: "Understand Gateway Authentication Controls"
sidebar-title: "Gateway Authentication"
description: "Review NemoClaw gateway access, dashboard exposure, secret redaction, and memory-scanning controls."
description-agent: "Explains NemoClaw gateway authentication and secret-handling controls. Use when reviewing dashboard exposure, device pairing, secret redaction, or memory scanning."
keywords: ["nemoclaw gateway authentication", "dashboard security", "secret redaction"]
content:
  type: "concept"
---
