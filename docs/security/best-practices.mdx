...
OpenClaw's security audit keeps NemoClaw-managed `allowInsecureAuth` and `dangerouslyDisableDeviceAuth` findings visible as accepted findings instead of counting them as unexplained active findings.
