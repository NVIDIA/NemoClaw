...
| Credential discovery | Host credential leakage and impossible ambient-provider probes. | Host adapter or agent runtime | No. New discovery sources require explicit provider design and validation. |
