...
This path requires local Docker Desktop, Arm64, the Windows N1x product identity, at least 48,000 MiB of GPU memory, and a successful Docker Desktop GPU passthrough proof.
Onboarding stops managed selection when the GPU proof fails.
