...
Onboarding recognizes one proof-backed GPU whose bounded NVIDIA identity contains `RTX Spark N1X`; the Windows chassis product name does not participate in selection.
