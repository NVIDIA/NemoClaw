...
Review gateway access, dashboard exposure, secret redaction, and memory scanning in [Understand Gateway Authentication Controls](./security-controls/gateway-authentication-controls).
