...
NemoClaw ships preset policy files in `nemoclaw-blueprint/policies/presets/` for common non-messaging integrations and channel-owned messaging policy files under `src/lib/messaging/channels/<channel>/policy/`.
