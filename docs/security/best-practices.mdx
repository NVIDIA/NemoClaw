...
If the image-baked resource-limit helper is missing or the effective limits remain above policy after hardening, the Deep Agents entrypoint and direct managed launcher refuse to start.
