...
5. Rebuild every sandbox that step 3 reported as detached with a current Hermes image, the key still exported, and that sandbox's other required credentials available.
