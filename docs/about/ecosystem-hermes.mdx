...
---
NemoClaw combines onboarding, lifecycle management, and operations with [OpenShell](https://github.com/NVIDIA/OpenShell) isolation and the [Hermes](https://hermes-agent.nousresearch.com/docs/) agent runtime; its `nemohermes` CLI alias preselects Hermes for `nemoclaw`.
