...
title: "NemoClaw in the Hermes Ecosystem"
sidebar-title: "Ecosystem"
description: "Learn how NemoClaw fits with Hermes and OpenShell, and when to use the reference stack or integrate OpenShell directly."
description-agent: "Positions NemoClaw within the Hermes and OpenShell ecosystem. Use when users need to choose NemoClaw or a direct OpenShell integration for Hermes."
...
---
NemoClaw provides onboarding, lifecycle management, and Hermes operations through the `nemohermes` CLI alias, which preselects Hermes for `nemoclaw`.
This page positions NemoClaw in the [Hermes](https://hermes-agent.nousresearch.com/docs/) and [OpenShell](https://github.com/NVIDIA/OpenShell) ecosystem and helps you choose an integration path.
Use [Overview](overview) for product capabilities and [Architecture Overview](how-it-works) for internal design and boundaries.

## NemoClaw Within the Hermes Ecosystem
