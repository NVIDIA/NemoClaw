...
| Routed inference           | The OpenShell gateway routes model traffic to your selected provider, transparent to the agent. You can switch providers or models. See [Inference Options](../inference/inference-options).          |
