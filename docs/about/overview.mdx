...
skill:
  priority: 10
---
import { AgentCli, AgentOnly, GuideLink } from "../_components/AgentGuide";
...
- <GuideLink href="/about/how-it-works">Architecture Overview</GuideLink> to understand how NemoClaw works.
- <GuideLink href="/about/ecosystem">Ecosystem</GuideLink> to understand how your agent, OpenShell, and NemoClaw relate in the wider stack, and when to use NemoClaw versus OpenShell.
<AgentOnly variant="openclaw">

- <GuideLink href="/get-started/quickstart">Quickstart with OpenClaw</GuideLink> to install NemoClaw and run your first OpenClaw sandbox.

</AgentOnly>
<AgentOnly variant="hermes">

- <GuideLink href="/get-started/quickstart-hermes">Quickstart with Hermes</GuideLink> to install NemoClaw and run your first Hermes sandbox with `nemohermes`.

</AgentOnly>
- <GuideLink href="/resources/agent-skills">Agent Skills</GuideLink> to load NemoClaw guidance into an AI coding assistant.
- <GuideLink href="/inference/inference-options">Inference Options</GuideLink> to check the inference providers that NemoClaw supports and how inference routing works.
