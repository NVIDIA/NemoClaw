...
- Read <GuideLink href="/about/ecosystem">Ecosystem</GuideLink> for stack-level relationships and NemoClaw versus OpenShell-only paths.
<AgentOnly variant="openclaw">

- Follow the <GuideLink href="/get-started/quickstart">Quickstart with OpenClaw</GuideLink> to launch your first sandbox.

</AgentOnly>
<AgentOnly variant="hermes">

- Follow the <GuideLink href="/get-started/quickstart-hermes">Quickstart with Hermes</GuideLink> to launch your first sandbox.
