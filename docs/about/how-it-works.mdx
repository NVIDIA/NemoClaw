...
title: "Architecture Overview for NVIDIA NemoClaw"
...
content:
  type: "concept"
---
NemoClaw runs supported agent runtimes inside OpenShell sandboxes through a host CLI, versioned blueprint, agent integration layer, and OpenShell gateway.
The design keeps operator control on the host while OpenShell enforces the sandbox boundary.
...
The following table describes the components in the architecture diagram.
