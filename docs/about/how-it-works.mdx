...
<Warning>
  ...
  It does not verify workspace readiness, machine authentication, or Kubernetes.
  The infrastructure administrator must control the target hostname and its DNS resolution.
