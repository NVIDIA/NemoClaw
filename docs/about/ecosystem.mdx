...
title: "NemoClaw in the OpenClaw Ecosystem"
sidebar-title: "Ecosystem"
description: "Learn how NemoClaw fits with OpenClaw and OpenShell, and when to use the reference stack or integrate OpenShell directly."
description-agent: "Positions NemoClaw within the OpenClaw and OpenShell ecosystem. Use when users need to choose NemoClaw or a direct OpenShell integration."
...
This page positions NemoClaw in the [OpenClaw](https://openclaw.ai) and [OpenShell](https://github.com/NVIDIA/OpenShell) ecosystem and helps you choose an integration path.
Use [Overview](overview) for product capabilities and [Architecture Overview](how-it-works) for internal design and boundaries.

## NemoClaw Within the OpenClaw Ecosystem
