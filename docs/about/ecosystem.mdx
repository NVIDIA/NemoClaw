...
description: "Learn how NemoClaw combines OpenShell with OpenClaw, and when to use the reference stack or integrate OpenShell directly."
description-agent: "Explains the NemoClaw ecosystem for OpenClaw and OpenShell. Use when users need to choose NemoClaw or a direct OpenShell integration."
keywords: ["nemoclaw ecosystem", "openclaw openshell", "nemoclaw vs openshell", "sandboxed openclaw"]
content:
  type: "concept"
agent-variants: ["openclaw"]
---
The NemoClaw ecosystem brings together NemoClaw onboarding and lifecycle operations, [OpenShell](https://github.com/NVIDIA/OpenShell) isolation, and the [OpenClaw](https://openclaw.ai) agent runtime.
...
For OpenClaw, the NemoClaw ecosystem comprises three pieces with distinct scopes: NemoClaw, OpenShell, and OpenClaw.
...
Use these topics to evaluate the product, inspect its architecture, or start the OpenClaw workflow.
