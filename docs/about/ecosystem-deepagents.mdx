...
description: "Learn how NemoClaw combines OpenShell with LangChain Deep Agents Code, and when to use the reference stack or integrate OpenShell directly."
description-agent: "Explains the NemoClaw ecosystem for Deep Agents Code and OpenShell. Use when users need to choose NemoClaw or a custom OpenShell integration for Deep Agents Code."
...
---
The NemoClaw ecosystem brings together NemoClaw onboarding and lifecycle operations, OpenShell isolation, and the LangChain Deep Agents Code runtime.
...
For Deep Agents Code, the NemoClaw ecosystem comprises three pieces with distinct scopes: NemoClaw, OpenShell, and LangChain Deep Agents Code.
The `nemo-deepagents` CLI alias preselects Deep Agents Code for `nemoclaw`.
...
Use these topics to evaluate the product, inspect its architecture, or start the Deep Agents workflow.
