...
title: "NemoClaw in the Deep Agents Ecosystem"
sidebar-title: "Ecosystem"
description: "Learn how NemoClaw fits with LangChain Deep Agents Code and OpenShell, and when to use the reference stack or integrate OpenShell directly."
description-agent: "Positions NemoClaw within the Deep Agents and OpenShell ecosystem. Use when users need to choose NemoClaw or a custom OpenShell integration for Deep Agents Code."
...
---
NemoClaw provides onboarding, lifecycle management, policy, and inference routing through the `nemo-deepagents` CLI alias, which preselects Deep Agents Code for `nemoclaw`.
This page positions NemoClaw in the Deep Agents Code and OpenShell ecosystem and helps you choose an integration path.
Use [Overview](overview) for product capabilities and [Architecture Overview](how-it-works) for internal design and boundaries.

## NemoClaw Within the Deep Agents Ecosystem
