...
- [Apply Policy Presets](apply-policy-presets) changes the current OpenShell policy.
- [Create Custom Policy Presets](create-custom-policy-presets) adds a reviewed custom destination.
