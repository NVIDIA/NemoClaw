...
- Fetch that template or use the local repo copy when available, verify its SHA-256 digest is \`83b79b6420ff2c9e82c95da6eb714d51e118325514df911d8ebf5d4327ebda79\`, write the exact bytes into a private temporary directory, then serve it from a helper bound to \`127.0.0.1\` on a random local port.
