...
<AccordionGroup>
  ...
  <Accordion title="Dashboard and Terminal Details">
    ...
    NemoClaw waits up to 90 seconds for the dashboard forward to bind.
    If the exact forward process exits before it binds, NemoClaw waits 1 second and retries once.
    If the process remains unbound at the deadline, NemoClaw stops that exact process and confirms its exit before retrying.
    The complete two-attempt sequence can take just over 3 minutes.
