...
<AccordionGroup>
  ...
  <Accordion title="Onboarding and Inference Details">
    ...
    The endpoint port must differ from `NEMOCLAW_OLLAMA_PROXY_PORT` (`11435` by default); configure a different free proxy port before onboarding when they conflict.
