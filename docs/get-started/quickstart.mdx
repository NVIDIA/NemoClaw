...
<AccordionGroup>
  ...
  <Accordion title="Use Docker and supported platforms">
    ...
    [Prerequisites](prerequisites#dgx-station-express-preparation) defines Station qualification, generic Ubuntu preparation, stock DGX OS validation, repair limits, and reboot handoff.
