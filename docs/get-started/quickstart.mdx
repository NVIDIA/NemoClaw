...
<AccordionGroup>
  ...
  <Accordion title="Onboarding and Inference Details">
    ...
    A custom OpenClaw sandbox uses the same validated whole-home transfer; OpenClaw's native plugin and package state is restored with every other path under the OpenShell-provided native home.
