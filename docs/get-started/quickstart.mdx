...
<AccordionGroup>
  ...
  <Accordion title="Use Docker and supported platforms">
    ...
    [Prepare DGX Station to Install NemoClaw](prerequisites/dgx-station-preparation) defines Station qualification, host preparation, trusted-pair and network boundaries, repair limits, and reboot handoff.
