...
<AccordionGroup>
  ...
  <Accordion title="Use Docker and supported platforms">
    ...
    [Prepare DGX Station for NemoClaw](prerequisites/dgx-station-preparation) defines Station qualification, generic Ubuntu preparation, stock DGX OS validation, repair limits, and reboot handoff.
