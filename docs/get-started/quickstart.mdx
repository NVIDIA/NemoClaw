...
The hosted installer follows the last-known-good release tag by default, so this command installs the maintained OpenClaw build without a version override.
