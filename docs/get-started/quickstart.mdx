...
<AccordionGroup>
  ...
  <Accordion title="Use a container runtime and supported platforms">
    ...
    Set `NEMOCLAW_PROVIDER=install-vllm` to bypass the prompt with managed-vLLM preview intent, or set another provider to enter standard onboarding directly.
