...
In non-interactive runs, set `NEMOCLAW_CONFIRM_LEGACY_MANAGED_RECREATE` to exactly `1` only after you verify the listed sandboxes used managed images.
Registry entries with recorded custom-image evidence remain blocked from automatic recreation.
