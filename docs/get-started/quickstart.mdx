...
<AccordionGroup>
  ...
  <Accordion title="Use a container runtime and supported platforms">
    ...
    Set `NEMOCLAW_PROVIDER=install-vllm` to bypass the prompt with managed-vLLM preview intent, or set a recognized provider other than Local NVIDIA NIM to enter standard onboarding directly.
