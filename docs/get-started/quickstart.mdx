...
<AccordionGroup>
  ...
  <Accordion title="Use Docker and supported platforms">
    ...
    DGX Station is Tested with limitations on one DGX Station GB300 running DGX OS `7.5.0`.
  ...
  <Accordion title="Installer Behavior and Platform Details">
    ...
    <Warning>
    DGX Station is Tested with limitations on one DGX Station GB300 running DGX OS `7.5.0`.
    Express install does not extend that validation to dual-Station configurations.
    </Warning>
