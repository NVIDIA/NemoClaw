...
<AccordionGroup>
  ...
  <Accordion title="Dashboard and Terminal Details">
    ...
    NemoClaw waits up to 90 seconds for the dashboard forward to bind and remain owned through OpenShell's first post-bind sandbox check.
    ...
    The ordinary two-attempt sequence can take just over 3 minutes; readiness-handoff retries use a separate one-minute delay budget.
