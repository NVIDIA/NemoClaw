...
During managed re-onboarding, NemoClaw merges restored `config.toml` user preference tables while keeping the freshly generated model routing, update settings, and provider metadata authoritative.
