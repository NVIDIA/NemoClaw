...
<Steps>
  ...
  <Step title="Complete Onboarding">
    If the installer offers **Express**, decline it to continue with interactive Deep Agents onboarding.
    Select **LangChain Deep Agents Code** when the installer prompts you to choose an agent.
    Enter `my-deepagents` as the sandbox name, or press Enter to accept the suggested `deepagents-code` name.
