...
<Steps>
  ...
  <Step title="Complete Onboarding">
    ...
    With the OpenShell Docker driver, stock Deep Agents Code onboarding uses the release's exact managed-image digest and does not build an image from a Dockerfile.
  </Step>
