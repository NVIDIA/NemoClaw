...
The onboard wizard asks for an inference provider, model, any required credential, sandbox name, optional Tavily web search, and policy tier before it prints the review summary.
...
The default Deep Agents sandbox name is `deepagents`.
