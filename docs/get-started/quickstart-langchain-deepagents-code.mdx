...
The wizard collects the agent, inference provider and model, sandbox name, web search choice, resources, and policy tier before it prints the review summary.
...
After you select **Apply configuration**, NemoClaw requests required credentials and starts creating or updating the selected resources.
