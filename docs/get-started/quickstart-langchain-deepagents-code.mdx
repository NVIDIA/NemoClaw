...
<Steps>
  ...
  <Step title="Complete Onboarding">
    ...
    <Note>
      ...
      On supported non-N1x express platforms, enter `n` if you want to select LangChain Deep Agents Code, a sandbox name, an inference provider, and a model interactively.
