...
- Continue with the [Quickstart](../quickstart) after your host passes preparation or validation.
- Follow [Set Up vLLM on Two DGX Stations](../../inference/local-inference/set-up-vllm-on-two-dgx-stations) for distributed serving after both hosts qualify.
