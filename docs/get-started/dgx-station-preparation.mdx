...
A stock DGX OS image requires a safe, root-owned `/etc/dgx-release` file with `DGX_PLATFORM=DGX Server for GALAXY-GB300`.
Qualification uses the latest `DGX_OTA_VERSION` and accepts `7.2.0`, `7.4.0`, or `7.5.0`.
