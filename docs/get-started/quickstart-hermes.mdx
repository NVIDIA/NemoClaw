...
The hosted installer follows the last-known-good release tag by default, so this command installs the maintained Hermes-capable build without a version override.
