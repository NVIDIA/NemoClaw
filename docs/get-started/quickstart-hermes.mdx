...
<AccordionGroup>
  ...
  <Accordion title="Use Portable Ollama">
    ...
    The explicit Portable selection is recorded in its lifecycle receipt. Later `nemohermes`
    commands use that receipt to retain the selected profile; they do not require the installer
    environment variable to remain exported.
