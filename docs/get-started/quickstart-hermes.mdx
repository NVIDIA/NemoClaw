...
<Steps>
  ...
  <Step title="Complete Onboarding">
    ...
    <Note>
      ...
      On platforms other than N1x, enter `n` if you want to select Hermes, a sandbox name, an inference provider, and a model interactively.
...
<AccordionGroup>
  ...
  <Accordion title="Use Docker and supported platforms">
    ...
    On platforms other than N1x, enter `n` to continue with interactive onboarding when you want to select the agent or other settings yourself.
