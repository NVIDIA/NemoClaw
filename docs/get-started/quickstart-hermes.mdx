...
<Steps>
  ...
  <Step title="Complete Onboarding">
    ...
    <Note>
      On supported platforms, the installer can offer **Express** before the agent-selection prompt.
      **Express** uses preselected settings for that platform and runs onboarding non-interactively.
      Decline **Express** to continue with this interactive Hermes flow.
