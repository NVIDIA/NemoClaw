...
<AccordionGroup>
  ...
  <Accordion title="Use Portable Ollama">
    ...
    Leave port `11434` free on `127.0.0.1`.
    A host Ollama service or leftover Portable container on that port fails inference create before the Portable Ollama runner starts.
