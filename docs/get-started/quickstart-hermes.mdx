...
<AccordionGroup>
  ...
  <Accordion title="Use Portable Ollama" id="use-portable-ollama">
    ...
    Before onboarding, complete the [Portable Ollama prerequisites](../inference/local-inference/set-up-ollama#use-portable-ollama-with-hermes), including the required Podman version check.
