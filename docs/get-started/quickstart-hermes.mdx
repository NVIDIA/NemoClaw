...
<Steps>
  ...
  <Step title="Complete Onboarding">
    ...
    <Note>
      ...
      With the bare install command, it creates the default OpenClaw sandbox.
      After it finishes, skip the remaining steps on this page and [continue with the `my-assistant` sandbox](/user-guide/openclaw/get-started/quickstart#continue-after-express-install).
