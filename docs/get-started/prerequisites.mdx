...
These probes establish local container GPU visibility; physical acceptance of the pinned managed-vLLM and Nemotron Ultra recipe remains a separate gate.

<Warning title="DGX Station Support Status">
DGX Station remains Deferred.
Product validation of this express-install boundary on physical DGX Station hardware is still pending.
</Warning>
