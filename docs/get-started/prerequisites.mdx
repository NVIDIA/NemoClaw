...
| DGX OS (Station) | Docker | Deferred | Deferred. For evaluation on a qualifying DGX Station GB300, follow [Prepare DGX Station for NemoClaw](prerequisites/dgx-station-preparation) before the Quickstart. |
