...
| npm        | 10 or later |
| OpenShell  | `0.0.117-dev.142-g26f2f9639`, installed and verified by `$$nemoclaw onboard` |
...
NemoClaw pins the OpenShell `dev` release at source commit `26f2f963936f68c0d5be36b34cda570d8f79f315`.
The installer accepts only runtime version `0.0.117-dev.142-g26f2f9639` and verifies every downloaded artifact by SHA-256.
