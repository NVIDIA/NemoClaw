...
| DGX Spark | Docker | Tested | Use the standard installer and `nemoclaw onboard`. For local inference, see [Set Up DGX Spark or DGX Station Local Inference](/inference/dgx-spark-station-local-inference). |
