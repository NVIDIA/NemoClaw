...
When the Docker target depends on a readable Docker configuration file and Node.js is unavailable, the installer defers the selection until it installs Node.js.
