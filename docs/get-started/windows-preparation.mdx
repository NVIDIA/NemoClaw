...
2. If policy does not allow automated terminal execution, ask the assistant to create a local `.bat` or `.ps1` fallback file and explain exactly what it runs before you execute it.
