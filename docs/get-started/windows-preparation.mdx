...
A CUDA-proven WSL host whose Windows product reports RTX Spark N1x uses available GPU memory to rank installed Ollama models.
When `qwen3.6:35b` is installed and at least 30,000 MiB is available, NemoClaw selects it before `qwen3.5:9b`.
