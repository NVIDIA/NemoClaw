...
This path requires local Docker Desktop, Arm64, the Windows N1x product identity, at least 48,000 MiB of GPU memory, and a successful Docker Desktop GPU passthrough proof during onboarding.
If the GPU proof fails, onboarding stops managed llama.cpp selection.
