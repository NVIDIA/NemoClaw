...
A Windows on Arm host with multiple GPUs can also select `qwen3.6:35b` when the provider proof matches every reported device and reports at least 30,000 MiB available.
