...
| Configure, inspect, and operate a deployment | [usage.md](../usage.md) | Explain named sandboxes and shared providers, one agent per sandbox, state selection, output, unchanged apply, and export/reapply |
