...
- The integrity pin, messaging render-safety, and provider-recovery follow-ups are covered by the integrity-pin suites, `test/messaging-build-applier-render-safety.test.ts`, and `test/onboarding/onboard-resume-provider-recovery.test.ts`.
