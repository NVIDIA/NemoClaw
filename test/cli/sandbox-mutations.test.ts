...
function writePolicyMutationOpenshellStub(home: string): string {
  ...
  fs.writeFileSync(
    ...
    [
      ...
      `      printf '{"scope":"sandbox","sandbox":"%s","status":"effective","policy_source":"sandbox","policy":{"network_policies":{"github":{"name":"github","host":"github.com"}}}}\\n' "\${!#}"`,
      "      exit 0",
      "      ;;",
      '    *" --base "*)',
      "      cat <<'YAML'",
