...
#
# Prereq: skill deployed with test/e2e-vpn/e2e-cloud-experimental/fixtures/skill-smoke-template.SKILL.md
...
#     bash test/e2e-vpn/e2e-cloud-experimental/features/skill/verify-sandbox-skill-via-agent.sh
#
# Optional:
