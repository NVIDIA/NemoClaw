...
#     bash test/e2e-vpn/e2e-cloud-experimental/features/skill/add-sandbox-skill.sh
#
#   SANDBOX_NAME=e2e-cloud-experimental \
#     SKILL_ID=demo-skill \
...
#   test/e2e-vpn/e2e-cloud-experimental/fixtures/skill-smoke-template.SKILL.md
#
# After deploy, optional: run one agent turn to prove the skill is used:
#   NVIDIA_API_KEY=nvapi-... SANDBOX_NAME=... SKILL_ID=... bash test/e2e-vpn/e2e-cloud-experimental/features/skill/verify-sandbox-skill-via-agent.sh
#
# Exit code:
