...
#   test/e2e-vpn/test-e2e-cloud-experimental.sh
#
...
#
# Usage:
#   bash test/e2e-vpn/e2e-cloud-experimental/openclaw-tui-in-sandbox.sh
#   bash test/e2e-vpn/e2e-cloud-experimental/openclaw-tui-in-sandbox.sh my-sandbox
#   bash test/e2e-vpn/e2e-cloud-experimental/openclaw-tui-in-sandbox.sh --manual
#
# Optional env:
