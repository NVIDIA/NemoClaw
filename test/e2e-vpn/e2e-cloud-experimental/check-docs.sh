...
#   test/e2e-vpn/e2e-cloud-experimental/check-docs.sh                    # both checks
#   test/e2e-vpn/e2e-cloud-experimental/check-docs.sh --only-links
#   test/e2e-vpn/e2e-cloud-experimental/check-docs.sh --only-cli
#   test/e2e-vpn/e2e-cloud-experimental/check-docs.sh --local-only
#   CHECK_DOC_LINKS_REMOTE=0 test/e2e-vpn/e2e-cloud-experimental/check-docs.sh
#   test/e2e-vpn/e2e-cloud-experimental/check-docs.sh path/to/a.md path/to/b.mdx
#
# Environment:
...
Usage: test/e2e-vpn/e2e-cloud-experimental/check-docs.sh [options] [extra.md/.mdx ...]
