...
#     NVIDIA_API_KEY=... bash test/e2e-vpn/test-hermes-discord-e2e.sh
...
NVIDIA_API_KEY_BACKUP="${NVIDIA_API_KEY:-}"
unset NVIDIA_API_KEY NVIDIA_API_KEY
info "NVIDIA_API_KEY and NVIDIA_API_KEY unset; gateway must hold the inference credential"
