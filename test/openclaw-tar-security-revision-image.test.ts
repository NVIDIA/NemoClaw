        ...
        try {
          ...
          const probe = docker([
            ...
            [
              ...
              "find /usr/local/lib/node_modules/openclaw /usr/local/lib/node_modules/npm -path '*/node_modules/tar/package.json' -exec node -p 'require(process.argv[1]).version' {} \\;",
              ...
              "test -r /usr/local/share/nemoclaw/tar-7.5.19/package.json",
