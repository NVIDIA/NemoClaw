...
export const vitestWatchTriggerPatterns: VitestWatchTriggerPattern[] = [
  ...
  },
  {
    ...
    testsToRun: runTests(
      ...
      "test/onboarding/onboard-fresh-create-recovery-resume-identity.test.ts",
      "test/onboarding/onboard-fresh-create-recovery-registration-identity.test.ts",
      ...
      "test/onboarding/onboard-messaging-image-configuration.test.ts",
      "test/onboarding/onboard-messaging-provider.test.ts",
      "test/onboarding/onboard-messaging-recreation.test.ts",
      "test/onboarding/onboard-prepared-build-context.test.ts",
      "test/onboarding/onboard-reservation-recreate.test.ts",
      "test/onboarding/onboard-sandbox-build-base.test.ts",
      "test/onboarding/onboard-sandbox-build-dashboard.test.ts",
