...
export const BASE_APT_SECURITY_FUNCTIONS = [
  [
    ...
    '    printf "arm64\\n"',
    '  elif [[ "$#" -eq 6 && "$1" == "-i" && "${2##*/}" == "libexpat1.deb" && "${3##*/}" == "libjq1.deb" && "${4##*/}" == "jq.deb" && "${5##*/}" == "vim-common.deb" && "${6##*/}" == "vim-tiny.deb" ]]; then',
    '    [[ -f "$2" && -f "$3" && -f "$4" && -f "$5" && -f "$6" ]]',
    "  else",
    "    return 64",
    "  fi",
  ...
  [
    ...
    '    */v/vim/vim-tiny_9.2.0782-1_amd64.deb) [[ "${15##*/}" == "vim-tiny.deb" ]] ;;',
    '    */v/vim/vim-tiny_9.2.0782-1_arm64.deb) [[ "${15##*/}" == "vim-tiny.deb" ]] ;;',
    "    *) return 64 ;;",
    "  esac",
    '  printf "%s\\n" "${16}" > "${15}"',
    "}",
  ...
  [
    ...
    '      "0e6e231d6d2430a92cf76f8a78506090418fa37758c33b31ed50dfbfc76e22ed  "*/vim-tiny.deb) ;;',
    '      "be30f7e9de0b872bec0128ccd890452c0e0e29d99017d16c0f3aa74164f6700d  "*/vim-tiny.deb) ;;',
    "      *) return 1 ;;",
    "    esac",
    "    (( count += 1 ))",
    "  done",
