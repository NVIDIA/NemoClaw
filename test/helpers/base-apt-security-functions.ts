...
export function baseAptSecurityFunctions(architecture: DebianArchitecture): string[] {
  ...
  return [
    ...
    [
      ...
      '    perl-base) [[ "${perl_packages_installed:-0}" == "1" ]] || return 64; printf "5.44.0-1nemoclaw1" ;;',
      '    perl) if [[ "${perl_packages_installed:-0}" == "1" ]]; then printf "5.44.0-1nemoclaw1"; else printf "5.40.1-6"; fi ;;',
    ...
    [
      "perl() {",
      '  [[ "${perl_packages_installed:-0}" == "1" ]] || return 64',
      '  case "$*" in',
