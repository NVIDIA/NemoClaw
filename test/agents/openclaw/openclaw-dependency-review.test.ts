...
check_contains "$optional_plugin_block" 'openclaw plugins install --force "npm-pack:\${plugin_install_archive}"' "optional plugin reviewed npm-pack install confirmation"
...
check_not_contains "$optional_plugin_block" 'pack_reviewed_npm_tarball' "optional plugin inline pack helper"
	...
	grep -Fq '["openclaw", "plugins", "install", "--force", \`npm-pack:\${packed.archivePath}\`]' "$messaging_build_applier"
