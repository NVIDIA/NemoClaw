...
override_path = "/opt/nemoclaw-hermes-plugin/googlechat_adapter.py"
...
if module._gc_outbound_bearer() != token:
    raise RuntimeError("installed Hermes override did not read the injected placeholder")
