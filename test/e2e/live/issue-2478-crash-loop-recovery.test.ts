...
test("gateway recovery restores the guard chain and keeps the recovered process identity for 15 seconds (#2478)", async ({
  artifacts,
  cleanup,
  environment,
  gateway,
  ...
  progress.phase("start the compatible endpoint and confirm host readiness");
