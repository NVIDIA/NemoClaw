...
Pi full lifecycle qualification runs on Linux AMD64 and Linux ARM64. Each architecture has a
catalogue target, native runner, and checked-in receipt. The receipt refresh check requires
