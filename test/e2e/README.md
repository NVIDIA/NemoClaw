...
controller. It then revalidates the internal repository origin, open PR, exact
head and base SHAs, risk plan, matching pending required-check state, compatible
trusted controller commit, and final live revision. It updates the required check to
