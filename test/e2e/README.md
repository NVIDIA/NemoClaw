...
The `config-export-v1-consumer` contract checks deterministic OpenClaw and Hermes exports with the
recorded v1 parser and native adapters. Live scenarios retain the installed-CLI artifact boundary.
