...
import type { E2eSemanticMetadata } from "../../../tools/e2e/semantic-coverage.mts";
...
// declares plan.expectedFailure. Distinct from PhaseName so a target
...
// User-facing phase the negative-target contract advertises. Wider
...
// targets should prefer Vitest phase fixtures rather than adding action
// dispatch records.
