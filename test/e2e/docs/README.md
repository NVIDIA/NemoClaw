...
- `.github/workflows/platform-vitest-main.yaml` publishes `CI / Platform Compatibility`.
  ...
  Shard 1 has a 150-minute job budget: 60 minutes for the pre-live shard and setup, a 70-minute live-E2E deadline, and 20 minutes for cleanup and artifacts.
