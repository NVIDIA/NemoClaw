...
- `.github/workflows/platform-vitest-main.yaml` runs the full Vitest suite in
  ...
  `.github/workflows/macos-e2e.yaml` and `.github/workflows/wsl-e2e.yaml` call
  focused E2E targets directly for platform coverage. `.github/workflows/e2e.yaml`
  selects free-standing jobs, including `whatsapp-qr-compact` and
  `ollama-auth-proxy`.
