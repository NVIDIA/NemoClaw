...
- `nemoclaw-user-deploy-remote` — Deploy to a Remote GPU Instance for persistent operation
- `nemoclaw-user-monitor-sandbox` — Monitor Sandbox Activity to observe agent behavior
