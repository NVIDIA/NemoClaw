...
- Before tag confirmation, show the newest identifiable full manual E2E result, compare its commit
  with the candidate, and let the maintainer run focused tests, run the full suite, or proceed with
