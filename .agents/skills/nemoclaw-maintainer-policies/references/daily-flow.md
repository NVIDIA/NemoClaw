...
- At 4 PM America/Los_Angeles, let the scheduled workflow tag the current `main` regardless of E2E state. Keep merging while the 4 PM-8 AM loop triages each SHA-bound post-merge E2E run.
