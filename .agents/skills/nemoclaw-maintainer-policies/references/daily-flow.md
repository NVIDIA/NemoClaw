...
| 7 | Close | At 4 PM, freeze the edition and stop merging while advisory review and consolidated E2E continue. |
...
- Dispatch an asynchronous agent review for each exact `main` SHA range. Run consolidated E2E after cutoff and prepare fixes during the freeze.
