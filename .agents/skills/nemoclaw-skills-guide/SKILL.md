...
| `nemoclaw-contributor-update-hermes` | Audit and deliver Hermes upgrades across release identity, configuration, compatibility shims, state, packaging, base-image publication, and runtime evidence for the PR SHA. |
