...
Covers engineering behavior, trusted checkout setup and readiness checks, creating pull requests that follow the project template, monitoring CI and automated review feedback, drafting documentation updates, and onboarding new messaging channels.
...
| `nemoclaw-contributor-engineering-guidelines` | Apply engineering behavior principles to assumptions, solution size, scope, observable outcomes, and QA-escaped defect analysis. |
