...
| `nemoclaw-contributor-update-dependencies` | Audit and implement a dependency upgrade from current upstream and downstream contracts. |
| `nemoclaw-contributor-update-hermes` | Apply the dependency workflow with Hermes-specific migration and publication priorities. |
