...
1. **Ready-now PR** — green CI, no conflicts, no confirmed major CodeRabbit or PR Review Advisor issues after maintainer adjudication, has tests → follow [MERGE-GATE.md](MERGE-GATE.md)
