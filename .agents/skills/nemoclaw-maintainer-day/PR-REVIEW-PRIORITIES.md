...
4. **4 PM–4 AM frozen loop**: Use exact-SHA post-merge agent reviews and one consolidated E2E run to diagnose regressions, rerun selectively, and prepare fixes without merging.
