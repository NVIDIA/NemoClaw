...
description: Review the current NemoClaw sprint progress, show status breakdown, maintainer work involvement, NV QA/UAT bug triage with trend analysis, and architecture alignment. Use when asking "sprint review", "sprint progress", "how's the sprint going", "sprint dashboard", "what's in the sprint", "sprint status", "QA triage", or "bug trends".
...
```bash
SCRIPT=".agents/skills/nemoclaw-sprint-review/collect_sprint_items.py"
