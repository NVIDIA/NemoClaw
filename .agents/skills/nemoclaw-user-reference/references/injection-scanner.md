...
If the input contains URL-encoded sequences (`%20`, `%3C`), the scanner decodes them and rescans.
If the input contains HTML entities (`&lt;`, `&#60;`, `&#x3C;`), the scanner decodes them and rescans.
