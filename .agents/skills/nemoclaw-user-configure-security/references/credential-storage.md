...
For the broader sandbox security model and operational trade-offs, see [Security Best Practices](../SKILL.md) and Architecture (use the `nemoclaw-user-reference` skill).
